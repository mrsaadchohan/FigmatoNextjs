...
function Published() {
    ...
    <div>
        <Sidebar/>
        <div  className={` px-5 mt-8 md:mt-10  sm:ml-64 ${
          isSidebarOpen ? "" : "ml-0"
        }`}>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3  gap-5'>
                <div className='p-8 shadow-md border'>
                    <p className='text-[16px] text-[#98A1B2]'>
                    Published on 23/12/23
                    </p>
                    <p className='mt-7 text-[14px]'>Been taking a tom of demo&apos;s lately</p>
                    <p className='mt-5 text-[14px]'>It&apos;s tiring to be honest</p>
                    <p className=' mt-5 text-[14px]'>There is a very very specific idea/problem/ strategy I&apos;m trying to solve for
                    </p>
                    ...
                    <p className='text-center text-slate-500'>View in my Linkedln Profile</p>
                    </div>
                </div>
